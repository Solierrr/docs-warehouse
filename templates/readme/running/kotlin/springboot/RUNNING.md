...
Este repositório é Kotlin + Spring Boot, buildado com Maven. O processo local é sempre o mesmo: clonar, abrir na IDE, baixar as dependências via `mvnw` e subir a aplicação. Antes de iniciar, verifique a seção de impedimentos abaixo — alguns repositórios dependem de credenciais externas mesmo em ambiente local.

<p>
  <a href="https://github.com/syvixor/skills-icons">
    <img src="https://skills.syvixor.com/api/icons?i=kotlin,springboot,spring,github,gcp" height="48" alt="Rodando o Projeto — Kotlin Spring Boot">
  </a>
</p>
